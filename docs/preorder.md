...
- [ ] **ปรับแท็บ "สินค้าจะมีการปรับราคา" ตามนิยามเอ้งชิ้ว** (distributor สั่ง lot ทุนเก่ามาสต็อกก่อนผู้ผลิตขึ้นราคา แล้วขายราคาใหม่ → กำไรส่วนต่าง): ผลประโยชน์อยู่ฝั่งเรา แท็บนี้มีไว้รวบรวม demand ให้จัดซื้อสั่ง lot เก่า ไม่ใช่ให้ลูกค้าล็อคราคาเดิม → ข้อความการ์ด "จองตอนนี้ได้ราคาเดิม" ต้องแก้ก่อน UAT · คำถามเปิด Q1–Q5 (ราคาที่ลูกค้าเห็น, บอกวันปรับราคาไหม, วันปิดรับ/เพดาน, ทุนเก่า-ใหม่ + กำไรคาดในใบสรุป, ล็อคราคา) อยู่ใน [UAT & Demo Guide](https://nitipongjin-13063.atlassian.net/wiki/spaces/R/pages/202473517) ถามตอน UAT
