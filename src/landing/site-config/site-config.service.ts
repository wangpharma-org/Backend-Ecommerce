...
const DEFAULT_CONFIGS = [
  ...
  // ---- Pre-order: ข้อความคงที่บนหน้าสั่งจองล่วงหน้า (แก้ได้จากหน้า admin site-config หมวด preorder) ----
  {
    config_key: 'preorder_intro',
    config_value:
      'สำหรับสินค้าที่ยังไม่มีในคลังสินค้า ท่านสามารถแจ้งจำนวนที่ต้องการไว้ล่วงหน้าได้ บริษัทจะจัดลำดับตามเวลาที่ท่านแจ้งความประสงค์ครั้งแรก และการปรับจำนวนภายหลังจะไม่กระทบลำดับของท่าน',
    config_type: ConfigType.TEXT,
    description: 'คำโปรยใต้หัวข้อหน้าสั่งจองล่วงหน้า (/preorder)',
    category: 'preorder',
  },
  {
    config_key: 'preorder_explain_allocation',
    config_value:
      'สินค้าในรอบนี้ขาดตลาดชั่วคราว บริษัทได้จัดหามาให้ได้ในจำนวนจำกัด จึงขออนุญาตจัดสรรตามลำดับการแจ้งความประสงค์ ท่านสามารถระบุจำนวนที่ต้องการไว้ล่วงหน้าได้ ระบบจะแจ้งลำดับของท่านให้ทราบ และหากต้องการปรับจำนวนภายหลัง ลำดับเดิมของท่านจะยังคงอยู่ เมื่อสินค้ามาถึง บริษัทจะจัดสรรตามลำดับและแจ้งจำนวนที่ท่านจะได้รับให้ทราบอีกครั้ง',
    config_type: ConfigType.TEXT,
    description: 'คำอธิบายรอบแบบสินค้าขาดตลาด (allocation) บนหน้าลูกค้า',
    category: 'preorder',
  },
  {
    config_key: 'preorder_explain_aggregation',
    config_value:
      'สินค้าดังกล่าวยังไม่มีในคลังสินค้า ท่านสามารถแจ้งจำนวนที่ต้องการไว้ล่วงหน้าได้ เมื่อยอดรวมจากร้านค้าทุกท่านถึงเงื่อนไขที่บริษัทกำหนด บริษัทจะดำเนินการสั่งซื้อจากผู้ผลิตให้ในคราวเดียว แถบสีเขียวบนการ์ดแสดงความคืบหน้าของยอดรวม ส่วน "คาดว่าของถึง" เป็นวันที่ประมาณการซึ่งอาจคลาดเคลื่อนได้ ราคาที่แสดงเป็นราคาโดยประมาณและอาจปรับเมื่อปิดรอบ ขอขอบพระคุณที่ให้ความไว้วางใจ',
    config_type: ConfigType.TEXT,
    description: 'คำอธิบายรอบแบบสั่งผลิตล่วงหน้าตามยอดรวม (aggregation) บนหน้าลูกค้า',
    category: 'preorder',
  },
  {
    config_key: 'preorder_explain_can_cancel',
    config_value: 'ท่านสามารถปรับจำนวนหรือยกเลิกได้จนกว่าจะปิดรอบ',
    config_type: ConfigType.TEXT,
    description: 'ประโยคต่อท้ายเมื่อรอบอนุญาตให้ลูกค้ายกเลิกเอง',
    category: 'preorder',
  },
  {
    config_key: 'preorder_explain_no_cancel',
    config_value:
      'ทั้งนี้ต้องขออภัยที่ไม่สามารถยกเลิกรายการได้หลังจากแจ้งความประสงค์แล้ว เนื่องจากบริษัทต้องชำระเงินล่วงหน้าเพื่อสำรองสินค้าให้ท่าน',
    config_type: ConfigType.TEXT,
    description: 'ประโยคต่อท้ายเมื่อรอบไม่อนุญาตให้ลูกค้ายกเลิกเอง',
    category: 'preorder',
  },
];
